...
The [GitHub wiki](https://github.com/remyjallan/impresairio/wiki) is the canonical guide for CLI usage, YAML configuration, agent profiles, workflows, recovery, documentation targets, and [project workflow skills](https://github.com/remyjallan/impresairio/wiki/Host-workflow-skills).
